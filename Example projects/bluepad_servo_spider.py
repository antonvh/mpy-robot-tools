...
right_eye = 100
while 1:
    ack, pad = ur.call('servos_gp','4i', brs.angle(), bls.angle(), frs.angle(), fls.angle())
    if ack=="servos_gpack":
    ...
    if right_eye < 0: right_eye = 0
    if right_eye > 100: right_eye = 100
    if left_eye < 0: left_eye = 0
    if left_eye > 100: left_eye = 100
